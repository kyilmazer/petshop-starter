  ...
  return (
    <section>
      <div className="h-[800px] flex flex-1 flex-col lg:flex-row lg:h-[324px] ">
        {/* input div */}
        <div
          className="bg-newsletterOrange bg-center bg-cover bg-no-repeat flex-1 flex flex-col 
        justify-center items-center px-8 lg:px-0 h-full">
          <div>
        ...
        {/* image div */}
        <div
          className="bg-newsletterYellow bg-center bg-no-repeat bg-cover flex-1 flex 
